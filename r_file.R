library('Quandl')
Quandl.auth("ffT8ALix-1Z9XisyY5iB")
...
plot(main = "mproved water source refers to the percentage of the population with reasonable access to an adequate amount of water from an improved source",x= accesss_to_improved_water_sources$Date,y=accesss_to_improved_water_sources$accesss_to_improved_water_sources_percent)
